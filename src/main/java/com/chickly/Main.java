...
//        }
        ...
        CustomerRepository customerRepository = new CustomerRepository(JpaUtil.getEntityManagerFactory().createEntityManager());
...
//            // Create Customers
//            Customer customer1 = new Customer();
//            customer1.setFirstName("Mahmoud");
//            customer1.setLastName("Essam");
//            customer1.setCreditLimit(new BigDecimal("1000.00"));
//            customer1.setDateOfBirth(new Date(85, 3, 12)); // Deprecated constructor
//            customer1.setEmail("MahmoudEssam@example.com");
//            customer1.setPhoneNumber("1234567890");
//            customer1.setAddress(address1);
//            customer1.setAccount(account1);
//            customerRepository.create(customer1);
//            customerRepository.entityManager.close();
//        EntityManagerFactory emf = Persistence.createEntityManagerFactory("chicly");
//        EntityManager em = emf.createEntityManager();
...
//em.getTransaction().commit();
        ...
        ProductRepository productRepository = new ProductRepository(JpaUtil.getEntityManagerFactory().createEntityManager());
        Product product = productRepository.readBy("name","Cool T-Shirt");
        productRepository.readSubProducts(product).stream().toList();
//         productRepository.readAll().stream().map(product -> new ArrayList<>(List.of(product,
//                        productRepository.readSubProducts(product).stream()
//                ))
